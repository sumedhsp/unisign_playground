...
train_label_paths = {
                    ...
                    "WLASL": "unisign_playground/data/WLASL/filtered_labels-2000.train"
                    }

dev_label_paths = {
                    "CSL_News": "./data/CSL_News/CSL_News_Labels.json",
                    "CSL_Daily": "./data/CSL_Daily/labels.dev",
                    "WLASL": "unisign_playground/data/WLASL/filtered_labels-2000.dev"
                    }

test_label_paths = {
                    "CSL_News": "./data/CSL_News/CSL_News_Labels.json",
                    "CSL_Daily": "./data/CSL_Daily/labels.test",
                    "WLASL": "unisign_playground/data/WLASL/filtered_labels-2000.test"
                    }
